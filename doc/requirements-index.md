...
| [REQ-2026-007](requirements/REQ-2026-007-loadbalancer-isolation.md) | 跨服务动态路由与负载均衡隔离 | Gateway 动态路由、Feign、公共负载均衡配置 | 0.3 | 开发中 | [需求文档 0.3](requirements/REQ-2026-007-loadbalancer-isolation.md) | 不涉及 | [详细设计 0.3](design/DESIGN-REQ-2026-007-loadbalancer-isolation.md) | [测试文档 0.3](test/TEST-REQ-2026-007-loadbalancer-isolation.md) | 用户 | 2026-09-24 |
