...
| 年份 | 下一个编号 | 最后分配日期 | 维护人 |
| --- | --- | --- | --- |
| 2026 | `REQ-2026-006` | 2026-09-16 | Codex |
...
| [REQ-2026-004](requirements/REQ-2026-004-image-prompt-reverse.md) | 图片提示词反推与标签化分析 | AI 分析、租户标签快照、提示词生成 | 0.2 | 待评审 | [需求文档 0.2](requirements/REQ-2026-004-image-prompt-reverse.md) | 不涉及 | 待编写 | 待编写 | 待指定 | 2026-09-15 |
